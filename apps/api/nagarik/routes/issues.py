...
def _to_read(issue: Issue) -> IssueRead:
    ...
    return IssueRead(
        ...
        diy_unlocked_at=getattr(issue, "diy_unlocked_at", None),
        diy_threshold_met_at=getattr(issue, "diy_threshold_met_at", None),
...
def create_issue(
    ...
    issue = Issue(
        ...
        before_audio_url=payload.before_audio_url,
